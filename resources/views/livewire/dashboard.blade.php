<div>
 ...
 Period ind Dashboard : {{$period}}
<div class="py-2">
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-right gap-2" style="position: relative; z-index: 999">

    <div class="grid grid-cols-10 gap-8 ">
      <div class="col-span-2 col-start-9 scale-100">
        <x-period-selector periodSelectorText="{{$periodSelectorText}}"/>
      </div>
    </div>
  ...
  @livewire('transaction-status-count',['period' => $period])
